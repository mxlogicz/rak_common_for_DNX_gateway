...
{
    if [ -f /opt/lora-gateway/packet_forwarder/lora_pkt_fwd/local_conf.json ];then
        GATEWAY_EUI=`do_get_json_value gateway_conf.gateway_ID /opt/lora-gateway/packet_forwarder/lora_pkt_fwd/local_conf.json`
    else
        GATEWAY_EUI=`do_get_json_value gateway_conf.gateway_ID /opt/lora-gateway/packet_forwarder/lora_pkt_fwd/global_conf.json`
    fi
    echo $GATEWAY_EUI
}
